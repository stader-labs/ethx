...
async function main() {
  ...
  const ssvNetwork = process.env.SSV_NETWORK ?? ''
  ...
  // const SSVNodeRegistryRegistry = await upgrades.deployProxy(SSVNodeRegistryFactory, [
  //   externalAdmin,
  //   staderConfig.address,
  //   ssvNetwork,
  //   ssvNetworkView
  // ])
  // console.log('SSVNodeRegistryRegistry deployed at ', SSVNodeRegistryRegistry.address)

  // const ssvPoolFactory = await ethers.getContractFactory('SSVPool')
  // const ssvPool = await upgrades.deployProxy(ssvPoolFactory, [
  //   externalAdmin,
  //   staderConfig.address,
  // ])
  // console.log('SSVPool deployed at ', ssvPool.address)
  ...
  const staderOracle = await upgrades.deployProxy(staderOracleFactory, [externalAdmin, staderConfig])
  ...
  // const ssvSocializingPoolContract = await upgrades.deployProxy(socializingPoolFactory, [
  //   externalAdmin,
  //   staderConfig.address,
  // ])
  // console.log('SSV socializingPoolContract deployed at ', ssvSocializingPoolContract.address)

  // const SSVValidatorWithdrawalVault = await ethers.getContractFactory('SSVValidatorWithdrawalVault')
  // const ssvValidatorVault = await SSVValidatorWithdrawalVault.deploy()
  // await ssvValidatorVault.deployed()
  // console.log('ssvValidatorVault ', ssvValidatorVault.address)


  // const SSVValidatorProxy = await ethers.getContractFactory('SSVVaultProxy')
  // const ssvProxyImpl = await SSVValidatorProxy.deploy()
  // await ssvProxyImpl.deployed()
  // console.log('ssvVault Proxy Impl ', ssvProxyImpl.address)
